...
def main():
    ...
    try:
        ...
        # bot.run()
        print("sumon-V2 Bot is starting safely...")
...
[7F8C8D]╟──────────────────────────────╢
[FFFFFF]⚡ Powered By : [BB8FCE]SUMON 9X
[FFFFFF]🎯 Status     : [2ECC71]ONLINE All time
[FFFFFF]📱 Contact    : [1ABC9C]tt [b][c]@sumon_9x_0
[7F8C8D]╟──────────────────────────────╢
...
[FFFFFF]@sumon_9x_0 💎
[00BFFF]╚════════════════════╝
[CCCCCC]✨ Developed by —͟͞͞ </> [00E5FF]—͞SUMON 9Xᅠ ❄️
"""
...
[C][B][FFD700]╰[FF0000]─[FFD700]╯[FFFFFF]
[C][B][FF0000]━━━━━━━━━━━
[C][B][FFFFFF]Username   : [00BFFF]sumon_9x_official
[C][B][FFFFFF]Signature  : [00BFFF]I LOVE MOM
